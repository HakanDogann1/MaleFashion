...
{
    public class EfAboutStatisticDal : GenericRepository<AboutStatistic>, IAboutStatisticDal
    {
        public EfAboutStatisticDal(MaleFashionContext context) : base(context)
        {
        }
    }
}
