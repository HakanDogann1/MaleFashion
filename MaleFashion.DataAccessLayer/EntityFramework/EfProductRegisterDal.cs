...
{
    public class EfProductRegisterDal : GenericRepository<ProductRegister>, IProductRegisterDal
    {
        public EfProductRegisterDal(MaleFashionContext context) : base(context)
        {
        }
    }
}
